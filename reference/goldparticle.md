...
A time series (`ts`) object containing 370 observations at equidistant
time points.

## Source

Jung, R.C.; Tremayne, A.R. (2006) Coherent forecasting in integer time
series models. *International Journal of Forecasting*, **22**, 223–238.

Westgren, A. (1916) Die Veraenderungsgeschwindigkeit der lokalen
Teilchenkonzentration in kolloidalen Systemen (Erste Mitteilung). *Arkiv
foer Matematik, Astronomi och Fysik*, **11**, 1–24.
