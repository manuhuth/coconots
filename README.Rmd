...
For the probability integral transform histogram, the histigram is plotted automatically. For the bootstrap and the forecast, the plots can be used using R's plot function.
